...
public class MessageSystemlistAdapter extends BaseAdapter {
	...
	private ArrayList<MessageSystemDefine> mDevlist = null;
	private LayoutInflater mInflater = null;
	private Context mContext = null;
	private Handler mHandler = null;

	public MessageSystemlistAdapter(Context context,
			ArrayList<MessageSystemDefine> devList) {
		mContext = context;
	...
	private class ViewHolder {
		...
		public void ViewData(MessageSystemDefine device, int position) {
			if (device != null) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			...
			convertView = mInflater.inflate(R.layout.view_messge_system_item, null);
		...
		if (holder != null && mDevlist != null && position < mDevlist.size()) {
			MessageSystemDefine FavoriteItem = mDevlist.get(position);
