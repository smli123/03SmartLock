...
public class ActivityModifyEmail extends TitledActivity implements
		OnClickListener {
			...
			if (intent.getAction().equals(PubDefine.USER_MODIFY_EMAIL)) {
				...
				case 0:
					...
					PubFunc.thinzdoToast(
							ActivityModifyEmail.this,
							context.getString(R.string.app_mod_email_ok));
					ActivityModifyEmail.this.finish();
					break;
				case 1:
					timeoutHandler.removeCallbacks(timeoutProcess);
					PubFunc.thinzdoToast(
	...
	protected void onCreate(Bundle savedInstanceState) {
		super.onCreate(savedInstanceState, R.layout.activity_setting_account_modify_email,
				false);
	...
	private void modfiyEmail() {
		...
		sb.append(SmartLockMessage.CMD_SP_MODEMAIL).append(StringUtils.PACKAGE_RET_SPLIT_SYMBOL)
	...
	private Runnable timeoutProcess = new Runnable() {
		...
		@Override
		public void run() {
			PubFunc.thinzdoToast(ActivityModifyEmail.this, SmartLockApplication
