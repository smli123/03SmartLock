...
import com.sherman.smartlockex.ui.util.ShermanCheckBox;
...
public class ActivityModifyPasswd extends TitledActivity implements
		OnClickListener {

	//private EditText oldPwd;
	private EditText newPwd1;
	private EditText newPwd2;
	private ShermanCheckBox checkPwd = null;
	...
	protected void onCreate(Bundle savedInstanceState) {
		super.onCreate(savedInstanceState, R.layout.activity_setting_account_modify_pwd, false);
	...
	private void modfiyPasswd() {
		...
		sb.append(SmartLockMessage.CMD_SP_MODPWD).append(StringUtils.PACKAGE_RET_SPLIT_SYMBOL)
