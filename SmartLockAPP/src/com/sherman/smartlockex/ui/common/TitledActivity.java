...
//		registerReceiver(mBroadcastReceiver, filter);    	
    ...
    protected void onCreateBaiduMap(Bundle savedInstanceState, int layoutResID, boolean backToExit) {
    	...
    	super.onCreate(savedInstanceState);
    	requestWindowFeature(Window.FEATURE_NO_TITLE);
    	Context context = SmartLockApplication.getContext();
    	super.setContentView(R.layout.view_common_titlebar);
    	setContentView(layoutResID);
    	...
    	if (true == mBack2Exit) {
    		...
    		if (keyCode == KeyEvent.KEYCODE_BACK && event.getRepeatCount() == 0) { 
    			...
    			new AlertDialog.Builder(this)
    				.setMessage(this.getString(R.string.smartlock_exit))
    				.setPositiveButton(R.string.smartlock_ok, okListener)
    				.setNegativeButton(R.string.smartlock_cancel, null)
