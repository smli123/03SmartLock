...
public class ConnectInfo {
	...
	public ConnectInfo(String strIP, int strPort, String strCookie, Timer timer, ModuleHeartBeatTask bTask)
	{
		...
		this.setAlive(true);
		this.setTsLastTime(new Timestamp(0));
	}
	...
	public Timestamp getTsLastTime() {
		return tsLastTime;
	}

	public void setTsLastTime(Timestamp tsLastTime) {
		this.tsLastTime = tsLastTime;
	}
}
