...
public class MESSAGE_System {
	public final static String 	TABLE_NAME = "message_system";	//数据库表名
	...
	public MESSAGE_System(int messageId, String strModuleId, int messageType, int messageData, int userType, String strUserMemo)
	{
	...
	public boolean equal(MESSAGE_System info)
	{
		if(null == info)
		{
			return false;
