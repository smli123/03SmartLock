...
public class ServerDBMgr {
	...
	public boolean InsertModuleInfo(MODULE_INFO module_info) 
	{
		...
		content.put(MODULE_INFO.TV_NAME, module_info.getTVName());
		try {
...
//	}
	 ...
	 * ********************************************************************************************************/
	/**
	 * @name InsertSceneInfo 增加一个红外数据定时器
	 * @param info 定时器的相关信息
	 * @return boolean 是否成功
	 * @throws SQLException ClassNotFoundException
	 * @author zxluan
	 * @date 2015/04/09
	 */
	public boolean InsertSceneInfo(MODULE_SCENE info)
	{
		Map<String,String> content = new HashMap<String,String>();
		content.put(MODULE_SCENE.SCENE_ID, String.valueOf(info.getScene_id()));
		content.put(MODULE_SCENE.SCENE_NAME, String.valueOf(info.getScene_name()));
		content.put(MODULE_SCENE.POWER_ENABLE, String.valueOf(info.getPower_enable()));
		content.put(MODULE_SCENE.POWER_MODULEID, String.valueOf(info.getPower_moduleid()));
		content.put(MODULE_SCENE.POWER_CONTROL, String.valueOf(info.getPower_control()));
		
		content.put(MODULE_SCENE.CURTAIN_ENABLE, String.valueOf(info.getCurtain_enable()));
		content.put(MODULE_SCENE.CURTAIN_MODULEID, String.valueOf(info.getCurtain_moduleid()));
		content.put(MODULE_SCENE.CURTAIN_CONTROL, String.valueOf(info.getCurtain_control()));
		content.put(MODULE_SCENE.AIRCON_ENABLE, String.valueOf(info.getAircon_enable()));
		content.put(MODULE_SCENE.AIRCON_MODULEID, String.valueOf(info.getAircon_moduleid()));
		content.put(MODULE_SCENE.AIRCON_TEMPERATURE, String.valueOf(info.getAircon_temperature()));
		content.put(MODULE_SCENE.AIRCON_CONTROL, String.valueOf(info.getAircon_control()));

		content.put(MODULE_SCENE.PC_ENALBE, String.valueOf(info.getPc_enable()));
		content.put(MODULE_SCENE.PC_MODULEID, String.valueOf(info.getPc_moduleid()));
		content.put(MODULE_SCENE.PC_MAC_MODULEID, String.valueOf(info.getPc_mac_moduleid()));
		content.put(MODULE_SCENE.PC_MAC_ADDRESS, String.valueOf(info.getPc_mac_address()));
		content.put(MODULE_SCENE.PC_CONTROL, String.valueOf(info.getPc_control()));

		content.put(MODULE_SCENE.USER_NAME, String.valueOf(info.getUser_name()));
		
		try {
			return m_dbTool.insert(MODULE_SCENE.TABLE_NAME, content);
		} catch (SQLException e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
			LogWriter.WriteExceptionLog(LogWriter.SRV_SELF_LOG,e,"");
	 ...
	 * @date 2015/04/09
	 */
	public boolean DeleteSceneInfo(int Id, String strUserName)
	{
		Map<String,String> selection 	= new HashMap<String,String>();
		selection.put(MODULE_SCENE.SCENE_ID, String.valueOf(Id));
		selection.put(MODULE_SCENE.USER_NAME, strUserName);
		try {
			return m_dbTool.delete(MODULE_SCENE.TABLE_NAME, selection);
		} catch (SQLException e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
			LogWriter.WriteExceptionLog(LogWriter.SRV_SELF_LOG,e,"");
	...
	/**
	 * @name DeleteSceneInfo 删除该模块的所有定时器任务
	 * @param strModuleId 定时器所属模块ID
	 * @return boolean 是否成功
	 * @throws SQLException
	 * @author zxluan
	 * @date 2015/04/09
	 */
	public boolean DeleteSceneInfo(String strUserName) 
	{
		Map<String,String> selection 	= new HashMap<String,String>();
		selection.put(MODULE_SCENE.USER_NAME, strUserName);
		try {
	...
	/**
	 * @name ClearSceneInfo 删除所有定时器
	 * @return boolean 是否成功
	 * @throws SQLException
	 * @author zxluan
	 * @date 2015/04/09
	 */
	public boolean ClearSceneInfo()
	{
		try {
			return m_dbTool.delete(MODULE_SCENE.TABLE_NAME);
		} catch (SQLException e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
			LogWriter.WriteExceptionLog(LogWriter.SRV_SELF_LOG,e,"");
	 ...
	 * @date 2015/04/09
	 */
	public boolean UpdateSceneInfo(MODULE_SCENE info) 
	{
		Map<String,String> selection 	= new HashMap<String,String>();
		Map<String,String> content 	= new HashMap<String,String>();
		//执行条件
		selection.put(MODULE_SCENE.SCENE_ID, String.valueOf(info.getScene_id()));
		selection.put(MODULE_SCENE.USER_NAME, info.getUser_name());
		//更新内容
		content.put(MODULE_SCENE.SCENE_ID, String.valueOf(info.getScene_id()));
		content.put(MODULE_SCENE.SCENE_NAME, String.valueOf(info.getScene_name()));
		content.put(MODULE_SCENE.POWER_ENABLE, String.valueOf(info.getPower_enable()));
		...
		content.put(MODULE_SCENE.USER_NAME, String.valueOf(info.getUser_name()));
		try {
			return m_dbTool.update(MODULE_SCENE.TABLE_NAME, content, selection);
		} catch (SQLException e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
			LogWriter.WriteExceptionLog(LogWriter.SRV_SELF_LOG,e,"");
	...
	/**
	 * @name InsertUpdateSceneInfo 更新定时器时间
	 * @param info 定时器信息
	 * @return boolean 是否成功
	 * @throws SQLException
	 * @author zxluan
	 * @date 2015/04/09
	 */
	public boolean InsertUpdateSceneInfo(MODULE_SCENE info) 
	{
		Map<String,String> selection 	= new HashMap<String,String>();
		Map<String,String> content 	= new HashMap<String,String>();
		//执行条件
		...
		content.put(MODULE_SCENE.USER_NAME, String.valueOf(info.getUser_name()));
		try {
			return m_dbTool.insert_or_update (MODULE_SCENE.TABLE_NAME, content, selection);
		} catch (SQLException e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
			LogWriter.WriteExceptionLog(LogWriter.SRV_SELF_LOG,e,"");
	 ...
	 * @date 2015/04/09
	 */
	public MODULE_SCENE QuerySceneInfo(String strUserName, int scene_id)
	{
		Map<String,String> selection = new HashMap<String,String>();
		selection.put(MODULE_SCENE.SCENE_ID, String.valueOf(scene_id));
		selection.put(MODULE_SCENE.USER_NAME, strUserName);
		ResultSet rs;
		try {
			rs = m_dbTool.query(MODULE_SCENE.TABLE_NAME, selection);
			if(rs.next())
			{
				return new MODULE_SCENE(
						rs.getInt(MODULE_SCENE.SCENE_ID),
						rs.getString(MODULE_SCENE.SCENE_NAME),
						rs.getInt(MODULE_SCENE.POWER_ENABLE),
						rs.getString(MODULE_SCENE.POWER_MODULEID),
						rs.getInt(MODULE_SCENE.POWER_CONTROL),
						rs.getInt(MODULE_SCENE.CURTAIN_ENABLE),
						rs.getString(MODULE_SCENE.CURTAIN_MODULEID),
						rs.getInt(MODULE_SCENE.CURTAIN_CONTROL),
						rs.getInt(MODULE_SCENE.AIRCON_ENABLE),
						rs.getString(MODULE_SCENE.AIRCON_MODULEID),
						rs.getInt(MODULE_SCENE.AIRCON_TEMPERATURE),
						rs.getInt(MODULE_SCENE.AIRCON_CONTROL),
						rs.getInt(MODULE_SCENE.PC_ENALBE),
						rs.getString(MODULE_SCENE.PC_MODULEID),
						rs.getString(MODULE_SCENE.PC_MAC_MODULEID),
						rs.getString(MODULE_SCENE.PC_MAC_ADDRESS),
						rs.getInt(MODULE_SCENE.PC_CONTROL),
						rs.getString(MODULE_SCENE.USER_NAME) );
			}
		} catch (ClassNotFoundException e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
	 ...
	 * @date 2015/04/09
	 */
	public MODULE_SCENE QuerySceneInfo(String strUserName, String scene_name)
	{
		Map<String,String> selection = new HashMap<String,String>();
		selection.put(MODULE_SCENE.SCENE_NAME, scene_name);
		selection.put(MODULE_SCENE.USER_NAME, strUserName);
		ResultSet rs;
		try {
			rs = m_dbTool.query(MODULE_SCENE.TABLE_NAME, selection);
	 ...
	 * @date 2015/04/09
	 */
	public Vector<MODULE_SCENE> QuerySceneInfoList(String strUserName)
	{
		Vector<MODULE_SCENE> vecTimerInfo = new Vector<MODULE_SCENE>();
		Map<String,String> selection = new HashMap<String,String>();
		selection.put(MODULE_SCENE.USER_NAME, strUserName);
		ResultSet rs;
		try {
			...
			while(rs.next())
			{
				vecTimerInfo.add(new MODULE_SCENE(
						rs.getInt(MODULE_SCENE.SCENE_ID),
						rs.getString(MODULE_SCENE.SCENE_NAME),
						rs.getInt(MODULE_SCENE.POWER_ENABLE),
						rs.getString(MODULE_SCENE.POWER_MODULEID),
