...
public class AppGrowLightQrySunTimeHandle implements ICallFunction{
	 ...
	 * @param 	strMsg: 命令字符串 
	 * 					格式：<cookie>,APPQRYGROWLIGHTTIMECURVE,<username>,<module_id>,路数
...
//				ResponseToAPP(strMsgHeader, strUserName, ServerRetCodeMgr.SUCCESS_CODE, strMsg);
	...
	public int resp(Runnable thread_base, String strMsg) {
		...
		String strMsgHeader = ServerCommDefine.APP_GROWLIGHT_QRY_SUNTIME_MSG_HEADER;
		String strUserName 	= strRet[2].trim();
		String strModuleID	= strRet[3].trim();
