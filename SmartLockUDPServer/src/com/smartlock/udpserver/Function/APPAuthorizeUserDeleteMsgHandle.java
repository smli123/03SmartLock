...
public class APPAuthorizeUserDeleteMsgHandle implements ICallFunction{
	/**********************************************************************************************************
	...
	public int call(Runnable thread_base, String strMsg)
	{
		...
		try
		{
			...
			if(!dbMgr.DeleteUserModule(strAuthorizeUser, strModuleId))
			{
				dbMgr.Rollback();
				//关闭事务机制
				dbMgr.EndTansacion();
			...
			//通知 APP，删车成功
			NotifyToAPP(strUserName,strModuleId, strMsgHeader, ServerRetCodeMgr.SUCCESS_CODE, strAuthorizeUser);
			ResponseToAPP(ServerCommDefine.APP_DEL_PLUG_MSG_HEADER, strAuthorizeUser, strModuleId, ServerRetCodeMgr.SUCCESS_CODE);
