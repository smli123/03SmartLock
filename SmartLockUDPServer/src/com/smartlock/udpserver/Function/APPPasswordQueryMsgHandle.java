...
public class APPPasswordQueryMsgHandle implements ICallFunction{
	/**********************************************************************************************************
	...
	public int call(Runnable thread_base, String strMsg) 
	{
		...
		try
		{
			...
			try {	
				/* 待模块返回 */
				String moduleCommand = String.format("%s,%s,%s,%s,%d#", strCookie, ServerCommDefine.QRY_PASSWORD_MSG_HEADER, strUserName, strModuleId, iStatus);
...
ServerWorkThread thread = (ServerWorkThread)thread_base;
		...
		String strMsgHeader = ServerCommDefine.APP_QRY_PASSWORD_MSG_HEADER;
		String strUserName 	= strRet[2].trim();
		String strModuleID	= strRet[3].trim();
