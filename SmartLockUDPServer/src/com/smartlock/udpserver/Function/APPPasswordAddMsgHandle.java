...
public class APPPasswordAddMsgHandle implements ICallFunction{
	/**********************************************************************************************************
	...
	public int call(Runnable thread_base, String strMsg) 
	{
		...
		try
		{
			...
			try {
				...
				/* 待模块返回 */
				String moduleCommand = String.format("%s,%s,%s,%s,%s#", strCookie, ServerCommDefine.ADD_PASSWORD_MSG_HEADER, strUserName, strModuleId, strNEResult);
...
ServerWorkThread thread = (ServerWorkThread)thread_base;
		...
		String strMsgHeader = ServerCommDefine.APP_ADD_PASSWORD_MSG_HEADER;
		String strUserName 	= strRet[2].trim();
		String strModuleID	= strRet[3].trim();
